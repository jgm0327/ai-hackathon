...
여기서 구현하는 라우터는 계약 문서 1~4, 5, 8절(P0 + P1 일부)이다. 6~7절(STT/푸시)은
9/13 실기기 음성 검증 결과가 아직 없어 보류 중이다(각 라우터 모듈에 TODO로 남겨둠).
"""
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware

from src.api.routers import cards, health, jds, notion, projects, resume
...
# --- 남은 P1 (docs/05-api-contract.md 6~7절) ---
